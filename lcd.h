...
/* Basic operations */
#define ST7789_RST_Clr() gpio_down(GPIO_PIN_OLED_RST)
#define ST7789_RST_Set() gpio_up(GPIO_PIN_OLED_RST)

#define ST7789_DC_Clr() gpio_down(GPIO_PIN_OLED_DC)
#define ST7789_DC_Set() gpio_up(GPIO_PIN_OLED_DC)
#ifndef CFG_NO_CS
#define ST7789_Select() gpio_down(GPIO_PIN_OLED_CS)
#define ST7789_UnSelect() gpio_up(GPIO_PIN_OLED_CS)
#else
